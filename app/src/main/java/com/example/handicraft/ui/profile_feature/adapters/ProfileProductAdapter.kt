...
import com.example.handicraft.ui.product_feature.adapters.UiProduct
...
class ProfileProductAdapter(
    ...
    private val onProductClickListener: OnProfileProductClickListener
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductViewHolder {
        ...
        binding.root.layoutParams =
            (binding.root.layoutParams as ViewGroup.MarginLayoutParams).apply {
                width = ((Resources.getSystem().displayMetrics.widthPixels - 64.dpToPx()) / 3)
            }
...
interface OnProfileProductClickListener {
